...
namespace MakeJobWell.UI.MVC.Helper
{
    public class MailHelper
    {
        public static bool SendActivationCode(string firstName, string mail, Guid activationCode)
        {
            ...
            message.From = new MailAddress("makejobwell@gmail.com", "Make Job Well");
            ...
            NetworkCredential credential = new NetworkCredential("makejobwell@gmail.com", "welljobmake123");
