...
namespace MakeJobWell.DAL.Migrations
{
    ...
    [Migration("20210213144619_updateinguser")]
    partial class updateinguser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeJobWell.Core.Entity.Concrete.OperationClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MakeJobWell.Core.Entity.Concrete.UserOperationClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MakeJobWell.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 2, 13, 17, 46, 19, 427, DateTimeKind.Local).AddTicks(111),
            ...
            modelBuilder.Entity("MakeJobWell.Core.Entity.Concrete.UserOperationClaim", b =>
                {
                    b.HasOne("MakeJobWell.Core.Entity.Concrete.OperationClaim", "OperationClaim")
                        .WithMany()
